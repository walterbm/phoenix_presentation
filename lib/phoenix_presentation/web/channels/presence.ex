defmodule PhoenixPresentation.Web.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PhoenixPresentation.MyChannel do
        use PhoenixPresentation.Web, :channel
        alias PhoenixPresentation.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :phoenix_presentation,
                        pubsub_server: PhoenixPresentation.PubSub
end
